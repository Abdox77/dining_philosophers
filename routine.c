...
/*   Updated: 2024/05/09 12:07:54 by amohdi           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	*routine(void *args)
{
	...
	while (check_start_simulation(philo->data) == FALSE)
		;
	if (philo->id % 2 == 0)
		usleep((philo->data->time_to_eat / 2) * 1e3);
...
void	think(t_philo *philo)
{
	...
	usleep(philo->data->thinking_time * 1e3);
	safe_write(philo->data, curr_time, philo->id + 1, "is thinking");
}
